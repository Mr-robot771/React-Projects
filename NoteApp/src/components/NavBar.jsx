...
const NavBar = () => {
  ...
  return (
    <div>
      <nav className=" flex lg:flex justify-between py-4 px-10 border-b border-b-gray-300 shadow-sm  ">
        <div className="lg:flex justify-center items-center gap-2 font-medium text-2xl tracking-tighter overflow-hidden">
          <GrNotes size={25} />
