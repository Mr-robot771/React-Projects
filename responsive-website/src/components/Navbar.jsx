      ...
      <div className="px-4 mx-auto relative text-sm">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex justify-center space-x-12 items-center">
            ...
            <a
              href="#"
              className="bg-gradient-to-r from-violet-600 to-fuchsia-800 py-2 px-3 rounded-md"
            >
              Create an account
            </a>
          </div>
        ...
        {mobileDrawerOpen && (
          <div className="lg:hidden fixed right-0 z-20 bg-neutral-900 w-full p-12 flex flex-col justify-center items-center">
            ...
            <div className="flex space-x-6">
              ...
              <a href="#" className="py-2 px-3 rounded-md bg-gradient-to-r from-violet-600 to bg-fuchsia-800">Create an account</a>
            </div>
          </div>
        )}
      </div>
